...
#
# Generated by Vivado on Mon Sep 28 18:01:55 +0200 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_wiz_1 xil_defaultlib.clk_wiz_1 xil_defaultlib.glbl -log elaborate.log
}
